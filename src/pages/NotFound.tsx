...
export default function NotFound() {
  ...
  return (
    <section className="min-h-[60vh] bg-white px-6 py-24 flex items-center justify-center text-center">
      <div>
        <p className="text-[#9f1d1d] text-[14px] font-black">404</p>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          ...
          <Link to="/catalog" className="min-h-[48px] inline-flex items-center px-7 border-2 border-[#9f1d1d] text-[#7f1717] font-bold">{lang === "zh" ? "浏览产品" : "Browse products"}</Link>
        </div>
      </div>
    </section>
  );
